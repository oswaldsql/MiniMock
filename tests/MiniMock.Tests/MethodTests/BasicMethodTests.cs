...
public class BasicMethodTests
{
    ...
    {
        // Arrange
        var sut = Mock.IBasicMethods(mock => mock.VoidWithoutParameters(new ArgumentException("Test exception")));
    ...
    {
        // Arrange
        var sut = Mock.IBasicMethods(mock => mock.ReturnWithParameters("Value"));
